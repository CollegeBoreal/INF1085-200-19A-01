...
| Evaluate and compare the basic file system features and options     | `ls`, `touch`,                                |
...
| Create, delete, copy, and move files and directories                | `mkdir`, `cd`, `rm`, `mv`                     |
...
| Manage access to the root account                                   | `sudo`, `su`                                  |
